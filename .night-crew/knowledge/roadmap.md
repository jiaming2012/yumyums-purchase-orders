...
- **`sync-rxdb-browser-delivery-spike`** · **SLATED — run `overnight-20260726`** (new card, fanned
  out of `sync-rxdb-schema-and-replication` 2026-07-26 at slating) · *(the client track's Wave-0
  gate — everything client-side waits on its verdict)* · Prove in a **real browser**, against W1's
