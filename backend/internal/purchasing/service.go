...
//
// 🛑 CHANGEOVER: 2026-07-29. Until run overnight-20260729-2 this Monday was
// computed in America/Chicago, so for the hour between 23:00 Sunday Chicago and
// midnight Monday New York it named the PREVIOUS week. That boundary moves
// exactly once, on this changeover, and is NOT restated backwards — purchase
// orders and weekly COGS/payroll figures already acted on keep the week they
// were filed under. See migration 0072_app_timezone_new_york.sql.
