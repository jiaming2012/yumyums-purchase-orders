...
- **Query params:**
  ...
  - Both dates are interpreted in `America/Chicago` (the food-truck operating timezone). The two dates define an inclusive calendar window. For a Monday–Sunday workweek "May 25–31, 2026", send `from=2026-05-25&to=2026-05-31`.
