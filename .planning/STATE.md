...
Last activity: 2026-07-01 - Completed quick task 260701-a23: Rewrite Purchases-tab sync chip copy — "Synced from {date} — N checked" (manual) / "Reprocessed N pending — X auto-added, Y still pending" (reprocess_all)
