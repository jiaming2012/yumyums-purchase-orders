...
Last activity: 2026-06-07 - Completed quick task 260607-e1c: Receipt pipeline reliability — persist parse_error to DB + FE, Sonnet fallback when Haiku fails, render PDF receipts via iframe
