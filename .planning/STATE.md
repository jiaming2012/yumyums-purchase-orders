...
Last activity: 2026-06-07 - Completed quick task 260607-s6r: Broaden Retry parse button gate to items-mismatch rows (recovery UX for stuck pending row where parse succeeded but content was wrong — Restaurant Depot $1515.16 paired with Amazon Mktplace $65.62 bank tx)
