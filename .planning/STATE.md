...
Last activity: 2026-06-07 - Completed quick task 260607-koi: Retry parse button on pending review cards (POST /pending/{id}/retry-parse clears parse_error; FE button + click handler + toast)
