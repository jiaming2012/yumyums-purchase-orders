...
Last activity: 2026-06-07 - Completed quick task 260607-k1n: Receipt parser test strategy (float64 quantity tolerance + LLM response fixture corpus + worker integration scenario table)
