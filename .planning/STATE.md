...
Last activity: 2026-06-07 - Completed quick task 260607-fxl: Retry parse-failed rows on re-sync (parse_error IS NULL + items empty gate) + reject empty-items confirm unless reason=no_attachment_on_bank_tx (FE disabled button + BE 422)
